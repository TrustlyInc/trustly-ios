...
final class URLUtilsTests: XCTestCase {
    ...
    func testBuildEndpointUrlProdEnvironment() throws {
        ...
        let urlBuiltForWidget = try? URLUtils.buildEndpointUrl(resourceUrl: .widget, establishData: self.establishData as! [String : String])
        
        XCTAssertEqual(expectedUrlForWidget, urlBuiltForWidget)
        
        let urlBuiltForIndex = try? URLUtils.buildEndpointUrl(resourceUrl: .index, establishData: self.establishData as! [String : String])
    ...
    func testBuildEndpointUrlLocalEnvironmentWithOutLocalUrl() throws {
        ...
        XCTAssertThrowsError(try URLUtils.buildEndpointUrl(resourceUrl: .widget, establishData: self.establishData as! [String : String])) { error in
    ...
    func testBuildEndpointUrlLocalEnvironment() throws {
        ...
        XCTAssertNoThrow(try URLUtils.buildEndpointUrl(resourceUrl: .widget, establishData: self.establishData as! [String : String]))
