...
struct JSONUtils {
    ...
    static private func getJsonDataFrom(dicticionary: [AnyHashable : Any]) -> Data? {
    ...
    static func getJsonStringFrom(dicticionary: [AnyHashable : Any]) -> String? {
    ...
    static func getJsonBase64From(dicticionary: [AnyHashable : Any]) -> String? {
