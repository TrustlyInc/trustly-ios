...
public typealias TrustlyCallback = (_ returnParameters: [AnyHashable : Any]) -> Void;
...
protocol TrustlyProtocol {
    ...
    */
    func selectBankWidget(establishData: [AnyHashable : Any], onBankSelected: @escaping TrustlyCallback);
